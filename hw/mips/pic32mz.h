...
#define DEVCFG0_ICESEL_PGE2     0x00000008 /* Use PGC2/PGD2
                                            * (default PGC1/PGD1) */
...
#define DEVCFG1_FCKM_ENABLE     0x00008000 /* Enable fail-safe clk monitoring */
...
#define DEVCFG2_UPLLFSEL_24     0x40000000 /* USB PLL input clock is 24 MHz
                                            * (default 12 MHz) */
...
#define DEVCFG3_PGL1WAY         0x08000000 /* Permission Group Lock -
                                            * only 1 reconfig */
#define DEVCFG3_PMDL1WAY        0x10000000 /* Peripheral Module Disable -
                                            * only 1 reconfig */
...
#define PIC32_PMMODE_IRQM_END   0x2000  /* Interrupt at end of r/w cycle */
...
#define PIC32_UMODE_IREN        0x1000  /* IrDA Encoder and Decoder Enable */
 ...
 */
#define PIC32_USTA_URXDA        0x00000001 /* Receive Data Available (ro) */
#define PIC32_USTA_OERR         0x00000002 /* Receive Buffer Overrun */
#define PIC32_USTA_FERR         0x00000004 /* Framing error detected (ro) */
#define PIC32_USTA_PERR         0x00000008 /* Parity error detected (ro) */
#define PIC32_USTA_RIDLE        0x00000010 /* Receiver is idle (ro) */
#define PIC32_USTA_ADDEN        0x00000020 /* Address Detect mode */
#define PIC32_USTA_URXISEL      0x000000C0 /* Bitmask: RX interrupt when... */
#define PIC32_USTA_URXISEL_NEMP 0x00000000 /* ...receive buffer is not empty */
#define PIC32_USTA_URXISEL_HALF 0x00000040 /* ...RX buffer becomes 1/2 full */
#define PIC32_USTA_URXISEL_3_4  0x00000080 /* ...RX buffer becomes 3/4 full */
#define PIC32_USTA_TRMT         0x00000100 /* TX shift register empty (ro) */
#define PIC32_USTA_UTXBF        0x00000200 /* Transmit buffer is full (ro) */
...
#define PIC32_USTA_UTXISEL      0x0000C000 /* Bitmask: TX interrupt when... */
#define PIC32_USTA_UTXISEL_1    0x00000000 /* ...at least 1 empty space */
#define PIC32_USTA_UTXISEL_ALL  0x00004000 /* ...all characters transmitted */
#define PIC32_USTA_UTXISEL_EMP  0x00008000 /* ...the TX buffer becomes empty */
...
#define PIC32_CFGCON_CPUPRI     0x01000000 /* CPU gets High Priority
                                            * access to SRAM */
#define PIC32_CFGCON_ICACLK     0x00020000 /* Input Capture alternate clock */
#define PIC32_CFGCON_OCACLK     0x00010000 /* Output Compare alternate clock */
...
#define PIC32_SPICON_SPIFE      0x00020000 /* Frame synchronization pulse
                                            * is the first bit clock */
#define PIC32_SPICON_FRMPOL     0x20000000 /* Frame pulse is active-high */
#define PIC32_SPICON_FRMSYNC    0x40000000 /* Frame sync pulse input */
...
#define ETHSCOLFRM      PIC32_R(0x82120) /* Single collision statistics */
#define ETHMCOLFRM      PIC32_R(0x82130) /* Multiple collision statistics */
#define ETHFRMRXOK      PIC32_R(0x82140) /* Frames received OK statistics */
#define ETHFCSERR       PIC32_R(0x82150) /* Frame check error statistics */
...
#define EMAC1IPGR       PIC32_R(0x82230) /* MAC non-back-to-back gap */
...
#define PIC32_ETHCON1_BUFCDEC       0x0001  /* Desc.buffer count decrement */
...
#define PIC32_ETHRXFC_PMMODE_BCAST  0x0600  /* Destination = broadcast */
...
#define PIC32_EMAC1CFG1_SIMRESET    0x4000  /* Reset TX random generator */
...
#define PIC32_EMAC1CFG1_PASSALL     0x0002  /* MAC accept ctl frames as well */
...
#define PIC32_EMAC1SUPP_SPEEDRMII   0x0100  /* RMII speed:
                                             * 1=100Mbps, 0=10Mbps */
...
/* IFS(0..5) - Interrupt Flag Status */
#define IFS(n)          PIC32_R(0x10040+((n)<<4))
...
#define IFS4            IFS(4)
#define IFS5            IFS(5)
/* IEC(0..5) - Interrupt Enable Control */
#define IEC(n)          PIC32_R(0x100c0+((n)<<4))
...
#define IEC4            IEC(4)
#define IEC5            IEC(5)
/* IPC(0..47) - Interrupt Priority Control */
#define IPC(n)          PIC32_R(0x10140+((n)<<4))
...
#define IPC46           IPC(46)
#define IPC47           IPC(47)
/* OFF(0..190) - Interrupt Vector Address Offset */
#define OFF(n)          PIC32_R(0x10540+((n)<<2))

/*
 * Interrupt Control register.
 */
#define PIC32_INTCON_INT0EP     0x00000001  /* Rising edge polarity for
                                             * external interrupt 0 */
#define PIC32_INTCON_INT1EP     0x00000002  /* Rising edge polarity for int1 */
#define PIC32_INTCON_INT2EP     0x00000004  /* Rising edge polarity for int2 */
#define PIC32_INTCON_INT3EP     0x00000008  /* Rising edge polarity for int3 */
#define PIC32_INTCON_INT4EP     0x00000010  /* Rising edge polarity for int4 */
#define PIC32_INTCON_TPC(x)     ((x)<<8)    /* Temporal proximity group prio */
#define PIC32_INTCON_MVEC       0x00001000  /* Multi-vectored mode */
#define PIC32_INTCON_SS0        0x00010000  /* Single vector has
                                             * a shadow register set */
 ...
 */
/* Priority */
#define PIC32_IPC_IP(a, b, c, d)    ((a)<<2 | (b)<<10 | (c)<<18 | (d)<<26)
/* Subpriority */
