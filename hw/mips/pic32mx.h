...
#define PIC32_UMODE_WAKE        0x0080  /* Wake-up on start in Sleep Mode */
...
#define PIC32_UMODE_IREN        0x1000  /* IrDA Encoder/Decoder Enable bit */
...
#define PIC32_USTA_URXISEL_HALF 0x00000040 /* ...receive buffer 1/2 full */
#define PIC32_USTA_URXISEL_3_4  0x00000080 /* ...receive buffer 3/4 full */
...
#define U1BDTP1         PIC32_R(0x85270) /* Buffer descriptor table ptr 1 */
...
#define U1BDTP2         PIC32_R(0x852C0) /* Buffer descriptor table ptr 2 */
#define U1BDTP3         PIC32_R(0x852D0) /* Buffer descriptor table ptr 3 */
...
#define PIC32_U1CON_JSTATE      0x0080 /* Live diff.receiver JSTATE flag */
...
#define PIC32_SPICON_SMP        0x00000200      /* Master mode: input sampled
...
#define PIC32_SPICON_FRMPOL     0x20000000      /* Frame pulse active-high */
...
#define BMXDKPBA        PIC32_R(0x82010)       /* Data RAM kernel program
                                                * base address */
#define BMXDUDBA        PIC32_R(0x82020)       /* Data RAM user data BA */
#define BMXDUPBA        PIC32_R(0x82030)       /* Data RAM user program BA */
#define BMXDRMSZ        PIC32_R(0x82040)       /* Data RAM size */
#define BMXPUPBA        PIC32_R(0x82050)       /* Program Flash user program */
...
#define DEVCFG0_ICESEL          0x00000008 /* Use PGC1/PGD1
                                            * (default PGC2/PGD2) */
...
#define DEVCFG1_FNOSC_FRCDIVPLL 0x00000001 /* Fast RC with div-by-N and PLL */
...
#define DEVCFG1_FCKM_DISABLE    0x00004000 /* Fail-safe clk monitor disable */
...
#define DEVCFG3_FSRSSEL_ALL     0x00000000 /* All irqs use a shadow set */
#define DEVCFG3_FSRSSEL_1       0x00010000 /* Assign SS for irq priority 1 */
#define DEVCFG3_FSRSSEL_2       0x00020000 /* Assign SS for irq priority 2 */
#define DEVCFG3_FSRSSEL_3       0x00030000 /* Assign SS for irq priority 3 */
#define DEVCFG3_FSRSSEL_4       0x00040000 /* Assign SS for irq priority 4 */
#define DEVCFG3_FSRSSEL_5       0x00050000 /* Assign SS for irq priority 5 */
#define DEVCFG3_FSRSSEL_6       0x00060000 /* Assign SS for irq priority 6 */
#define DEVCFG3_FSRSSEL_7       0x00070000 /* Assign SS for irq priority 7 */
 ...
 */
#define PIC32_INTCON_INT0EP     0x0001  /* Rising edge polarity for
                                         * external interrupt 0 */
#define PIC32_INTCON_INT1EP     0x0002  /* Rising edge polarity for int1 */
#define PIC32_INTCON_INT2EP     0x0004  /* Rising edge polarity for int2 */
#define PIC32_INTCON_INT3EP     0x0008  /* Rising edge polarity for int3 */
#define PIC32_INTCON_INT4EP     0x0010  /* Rising edge polarity for int4 */
...
#define PIC32_INTCON_SS0        0x8000  /* Single vector has
